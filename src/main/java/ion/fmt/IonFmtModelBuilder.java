...
public class IonFmtModelBuilder implements FormattingModelBuilder {
  ...
  private static SpacingBuilder createSpacingBuilder(@NotNull CodeStyleSettings settings) {
    return new SpacingBuilder(settings, IonLanguage.INSTANCE)
            ...
            .afterInside(IonToken.SEMICOLON, IonElementType.STMT_FOR).spacing(1, 1, 0, true, 0)

            .around(IonToken.COLON_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.LT).spacing(0, 1, 0, true, 0)
            .around(IonToken.LTEQ).spacing(0, 1, 0, true, 0)
            .around(IonToken.GT).spacing(0, 1, 0, true, 0)
            .around(IonToken.GTEQ).spacing(0, 1, 0, true, 0)
            .around(IonToken.NOTEQ).spacing(0, 1, 0, true, 0)
            .around(IonToken.EQ).spacing(0, 1, 0, true, 0)
            ...
            .around(IonToken.AND).spacing(0, 1, 0, true, 0)
            .around(IonToken.AND_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.AND_AND).spacing(0, 1, 0, true, 0)
            .around(IonToken.OR).spacing(0, 1, 0, true, 0)
            .around(IonToken.OR_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.OR_OR).spacing(0, 1, 0, true, 0)
            .around(IonToken.XOR).spacing(0, 1, 0, true, 0)
            .around(IonToken.XOR_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.ADD).spacing(0, 1, 0, true, 0)
            .around(IonToken.ADD_ASSIGN).spacing(0, 1, 0, true, 0)
            .afterInside(IonToken.SUB, IonElementType.EXPR_UNARY).spacing(0, 0, 0, false, 0)
            .around(IonToken.SUB).spacing(0, 1, 0, true, 0)
            .around(IonToken.SUB_ASSIGN).spacing(0, 1, 0, true, 0)
            ...
            .around(IonToken.MUL).spacing(0, 1, 0, true, 0)
            .around(IonToken.MUL_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.DIV).spacing(0, 1, 0, true, 0)
            .around(IonToken.DIV_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.MOD).spacing(0, 1, 0, true, 0)
            .around(IonToken.MOD_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.LSHIFT).spacing(0, 1, 0, true, 0)
            .around(IonToken.LSHIFT_ASSIGN).spacing(0, 1, 0, true, 0)
            .around(IonToken.RSHIFT).spacing(0, 1, 0, true, 0)
            .around(IonToken.RSHIFT_ASSIGN).spacing(0, 1, 0, true, 0)

            .around(IonToken.QUESTION).spacing(0, 1, 0, true, 0)
            .aroundInside(IonToken.COLON, IonElementType.EXPR_TERNARY).spacing(0, 1, 0, true, 0)
            ;
  }
}
