  ...
  public PsiElement createElement(ASTNode node) {
    ...
    if (typeId != null) {
      switch (typeId) {
        ...
        case TYPE_QNAME:
          return new IonTypeQNamePsi(node);
        case TYPE_PAR:
          return new IonTypeParPsi(node);
        case TYPE_PTR:
          return new IonTypePtrPsi(node);
        case TYPE_CONST:
          return new IonTypeConstPsi(node);
        case TYPE_ARRAY:
          return new IonTypeArrayPsi(node);
        case TYPE_TUPLE:
          return new IonTypeTuplePsi(node);
        case TYPE_FUNC:
          return new IonTypeFuncPsi(node);
        case LABEL_NAME:
